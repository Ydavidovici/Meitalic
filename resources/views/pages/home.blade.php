...
@section('content')
    <!-- Hero -->
    <section class="w-full bg-gradient-to-br from-secondary via-primary to-accent py-20">
        <div class="container px-4 sm:px-6 lg:px-8">
            <div class="max-w-screen-lg mx-auto space-y-6 text-center lg:text-left">
    ...
    <section class="bg-neutral-100 py-20">
        <div class="container px-4 sm:px-6 lg:px-8">
            <div class="max-w-screen-md mx-auto text-center space-y-6">
                ...
                <p class="text-neutral-600">“A customer testimonial... no one ever raving any orates.”</p>
